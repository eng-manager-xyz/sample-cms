  ...
  return [
    {
      ...
      canonicalUrl,
      externalRouteId: `camo:${prefix}:live`,
      lifecycle: 'live',
      auteurState: 'published',
      outcome: 200,
      explanation: 'Camo Press permits serving, then Auteur reads the active immutable manifest.',
    },
    {
      id: `${prefix}-not-live`,
      label: 'Not live + draft',
      canonicalUrl: `${canonicalUrl}?case=not-live`,
      externalRouteId: `camo:${prefix}:not-live`,
      lifecycle: 'not_live',
      auteurState: 'draft_only',
      outcome: 404,
      explanation: 'Authoring may exist, but Camo Press deliberately gates the route to 404.',
    },
    {
      id: `${prefix}-archived`,
      label: 'Archived route',
      canonicalUrl: `${canonicalUrl}?case=archived`,
      externalRouteId: `camo:${prefix}:archived`,
      lifecycle: 'archived',
      auteurState: 'published',
      outcome: 404,
    ...
    },
    {
      ...
      externalRouteId: `camo:${prefix}:unsafe`,
      lifecycle: 'live',
      auteurState: 'missing',
      outcome: 503,
...
export const scenarioFixtures: ScenarioFixture[] = [
  {
    ...
    dimensions: [
      ...
      },
      {
        ...
        description: 'Stable route identity from Camo Press.',
      },
      {
        id: 'brand',
        label: 'Brand',
